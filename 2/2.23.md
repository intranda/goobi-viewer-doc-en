...
Within this section, the sidebar table of contents is also configured in the configuration file. Due to its thematic proximity, it is described in [chapter 2.20.2](2.20/2.20.2.md).

The download for original content is also described here. Historically, this is still described in c[hapter 2.30](2.30.md).
