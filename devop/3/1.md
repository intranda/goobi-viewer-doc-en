...
{% hint style="danger" %}
FIXME - Customize patch command, check how it is with Ubuntu 22.04, whether this is necessary or whether the JAVA\_HOME might work directly. Does not work with 20.04.
{% endhint %}
