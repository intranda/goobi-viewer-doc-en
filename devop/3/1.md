...
```bash
apt -y install git patch openjdk-11-jdk-headless tomcat9 mariadb-server apache2 ttf-mscorefonts-installer unzip zookeeperd python3-passlib python3-bcrypt libopenjp2-7
```
...
#
<strong>
</strong>## These two scripts pull the theme git repository regulary. The @daily part is only 
